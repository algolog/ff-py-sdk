...
contract_with_quoted_keys = re.sub('(\w+):', '"\g<1>":', contract_jscode)
contract_dict = ast.literal_eval(contract_with_quoted_keys)
contract_json = json.dumps(contract_dict)

abiDistributor = Contract.from_json(contract_json)

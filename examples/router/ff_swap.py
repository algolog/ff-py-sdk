...
from ffsdk.router.datatypes import SwapMode
...
# fetch quote
quote = client.fetchSwapQuote(USDC, USDT, amount, SwapMode.FIXED_INPUT)
...
# prepare swap
fee_bps = 10  # 0.1%
base64_txns = client.prepareSwapTransactions(USER_ACCOUNT.addr, fee_bps, quote)
